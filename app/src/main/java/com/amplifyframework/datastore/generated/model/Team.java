...
public final class Team implements Model {
  ...
  private final @ModelField(targetType="TaskModel") @HasMany(associatedWith = "team", type = TaskModel.class) List<TaskModel> addTask = null;
  ...
  public List<TaskModel> getAddTask() {
      return addTask;
  }
